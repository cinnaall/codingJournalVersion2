            ...
            <form action="{{Route('thoughts.update', $thought->id)}}" method="post">
                <div class="form-group">
                    ...
                    @method('PATCH')
                        ...
                        <input class="form-control" type="text" name="mythoughts" value="{{$thought->mythoughts}}">
                </div><br>
                <div class="form-group">
                    <label class="control-label" for="date">Date</label><br>
                    <input class="form-control" type="date" name="date" value="{{$thought->date}}">
                </div><br>
                <button type="submit" class="btn btn-block btn-danger">Update Thought</button>
            </form>
        </div>
    </div>
@endsection